...
namespace button_tester
{
    public class Settings
    {
        ...
        //{
        //    RegistryKey root = Registry.LocalMachine.OpenSubKey("software", true);
        //    root=root.CreateSubKey("ss");
        //    root=root.CreateSubKey("button tester");

        //    root.SetValue(null, Buttons.Count);

        //    for (int i = 0; i < Buttons.Count; ++i)
        //    {
        //        root.SetValue("name_" + i, Buttons[i].Name, RegistryValueKind.String);
        //        root.SetValue("pinid_" + i, Buttons[i].PinID, RegistryValueKind.DWord);
        //    }
        //}
